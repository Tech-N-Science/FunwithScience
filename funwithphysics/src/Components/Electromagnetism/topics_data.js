const Topics = [
    ...
    {
        topic:"Ohm's Law",
        details:`Ohm's law states that the voltage (V) between two point is directly proportional to the current (I) across that two point and the constant of proportionality is resistance (R) and the equation is given as "V=IR"`,
