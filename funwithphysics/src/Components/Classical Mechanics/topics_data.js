...
        μ is the coefficient of friction, when the two objects are in relative motion, we call it coefficient of kinetic friction and when they are static, it is called the static friction coefficient.`,
    ...
    },
    {
        topic: "Collision",
        image: collision,
        details: ["Collision is known as the sudden but short interaction of two or more than two bodies to exert a mutual influence, usually by exchanging energy. For example, two biliard balls, a hammer and a nail etc. "
            , <br />, <br />,
            "There are three types of collision, Perfectly elastic, Partially elastic and Perfectly inelastic."
            , <br />,


            "In perfectly elastic collision, two bodies bounces off without any loss in kinetic energy or momentum, for example: a hard cricket ball hitting a hard surface. ", <br />,
        ...
        process: "Use the first object's mass(m1), initial velocity(u1), final velocity(v1) and second object's mass(m1), initial velocity(u2) to find out the unknown velocity of the second object(v2).",
        siunit: "m/s",
        dimension: "L/S"
    },
    {
