...
const Topics = [
  ...
  },
  {
    topic: "Solid Sphere",
    image: solidSphere,
    details: `The sum of the products of each particle's mass and the square of its distance from the axis of rotation to represent a body's inclination to resist angular acceleration.`,
  ...
  },
  {
    topic: "Rod",
    image: rod,
    details: `The sum of the products of the mass of each particle in the body and the square of its distance from the axis of rotation to represent a body's tendency to resist angular acceleration.`,
    formula: "M.O.I = 1/2 × Mass × Radius² = 1/2 × M × R²",
    process:
      "Basically, for any rotating object, the moment of inertia can be calculated by taking the distance of each particle from the axis of rotation (r in the equation), squaring that value (that's the r² term), and multiplying it times the mass of that particle.",
    siunit: "kilogram-metre square",
