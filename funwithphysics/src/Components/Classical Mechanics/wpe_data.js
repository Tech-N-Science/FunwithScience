...
const Topics = [
    ...
    },
    {
        topic: "Power",
        image: power,
        details: `Power is a physical concept that has several different meanings, depending on the context and the information that is available. We can define power is the rate of doing work. It is the amount of energy consumed per unit time.`,
        formula: "P = W/t",
