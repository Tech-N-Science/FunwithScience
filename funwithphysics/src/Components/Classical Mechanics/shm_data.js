...
const Topics = [
    {
        topic: "Waves",
        image: waves,
        details: `Waves can be described as a dynamic disturbance of one or more than one quantities, which propagates through a medium. For more information visit ${<a href="https://en.wikipedia.org/wiki/Waves" target="_blank" rel="noreferrer">Wikipedia</a>}`,
        formula: "λ = v/f",
    ...
    },
    {
        ...
        details: `
            ...
            For more information visit ${<a href="https://en.wikipedia.org/wiki/Oscillation" target="_blank" rel="noreferrer">Wikipedia</a>}
        `,
