...
function Calculator({ match }) {
  ...
  const MassDefect =()=>{
      ...
      const calcResult= ()=>{
          let res;
          res=(atomicNumber*(Mptoton+Melectron)+(massNumber-atomicNumber)*Mneutron)-matom
          setResult(res)
      ...
      <Form>
          <Form.Group className="mb-4">
              <Form.Label>Enter the Atomic number (Z) (Number of protons)</Form.Label>
          ...
          <Form.Group className="mb-4">
              <Form.Label>Enter the Mass of Nuclide (matom)</Form.Label>
              <Form.Control type="number"
          ...
          <Form.Group className="mb-4">
              <Form.Label>Masss of Electron (me)</Form.Label>
              <Form.Control type="number"
              readOnly
              placeholder="(0.000548597 amu)"/>
          </Form.Group>
          <Form.Group className="mb-4">
              <Form.Label>Masss of Proton (mp)</Form.Label>
              <Form.Control type="number"
              readOnly
              placeholder="(1.007277 amu)"/>
          </Form.Group>
          <Form.Group className="mb-4">
              <Form.Label>Masss of Neutron (mn)</Form.Label>
              <Form.Control type="number"
              readOnly
              placeholder="(1.008665 amu)"/>
          </Form.Group>
          <Form.Group className="mb-4">
            <Form.Control
              readOnly
