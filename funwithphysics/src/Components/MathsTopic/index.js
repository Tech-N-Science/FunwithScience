...
import trigonometry from "../../Images/trigonometry.png"
...
function MathsTopic() {
    ...
    return (
        <div>
            <h3 className="learn-header" id="learn">Maths calculator</h3>
            <div id="fh5co-course-categories" className="mt-5 p-5">
				<div className="container">
					<div className="row">
					<MathsTopicItem name="Algebra" link="/" icon="icon-shop" image={algebra} >
							<p>Algebra is a discipline of mathematics that deals with symbols and the rules that govern their manipulation.</p>
							<p id="credit">Photo by <a href="https://unsplash.com/@antoine1003?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Antoine Dautry</a> on <a href="https://unsplash.com/s/photos/algebra-maths?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a></p>
							</MathsTopicItem>
					<MathsTopicItem name="Trigonometry" link="/" icon="icon-heart4" image={trigonometry}>
							<p>Trigonometry is a field of mathematics that focus on the relationship between triangle side lengths and angles. </p>
							 <p id="credit">Image by <a href="https://pixabay.com/users/dognamedseven-1619308/?utm_source=link-attribution&amp;utm_medium=referral&amp;utm_campaign=image&amp;utm_content=1034657">dognamedseven</a> from <a href="https://pixabay.com/?utm_source=link-attribution&amp;utm_medium=referral&amp;utm_campaign=image&amp;utm_content=1034657">Pixabay</a></p>
  							</MathsTopicItem>
						<MathsTopicItem name="Geometry" link="/" icon="icon-lab2" image={geometry}>
							<p>Geometry is a discipline of mathematics that explores how things are measured in terms of their sizes, forms, angles, and dimensions.</p>
						    <p id="credit">Photo by <a href="https://unsplash.com/@soheili?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Mahdi Soheili</a> on <a href="https://unsplash.com/s/photos/geometry?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a></p>
						</MathsTopicItem>
						...
						<MathsTopicItem name="Integration/Differentiation" link="/" icon="icon-home-outline" image={integration}>
							<p>Integration is a way of finding the whole by summing the parts.Differentiation is a technique for determining a function's derivative.</p>
						    <p id="credit">Photo by <a href="https://unsplash.com/@jeswinthomas?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Jeswin Thomas</a> on <a href="https://unsplash.com/s/photos/maths?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a></p>
						</MathsTopicItem>
