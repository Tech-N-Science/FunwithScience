    ...
    return (
        <>
         <nav className="navbar navbar-expand-lg navbar-light bg-light pt-3">
            <p style={{padding: "0px", fontSize: "30px"}} className="navbar-brand ml-5" href="#"> <i class="fas fa-book"></i><i class="fas fa-book"></i><i class="fas fa-book"></i> Fun With Physics</p>
