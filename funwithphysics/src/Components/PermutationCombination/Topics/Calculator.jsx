...
function Calculator({ match }) {
  ...
  const Topics = [
    ...
    {
      topic: 'Combination',
      details: `A combination is a mathematical technique for determining the number of possible arrangements in a group of objects where the order of the items is irrelevant. Selecting r objects out of the given n objects is given by using the factorials. It is denoted by nCrnCr.`,
      formula: 'C = n!/r!(n-r)!',
      process:
