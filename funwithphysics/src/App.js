...
import Calpermutation from './Components/PermutationCombination/Topics/Calculator';
...
// import PermutationCombination from './Components/PermutationCombination/PermutationCombination';
import Algebra from './Components/PermutationCombination/PermutationCombination';
const Home = lazy(() => {
  return Promise.all([
    ...
    <React.Fragment>
      ...
      <Context.Provider value={{ state, dispatch }}>
        <Switch>
          ...
          <Route exact path='/algebra/calc/:topic' component={Calpermutation} />
